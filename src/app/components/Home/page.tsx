...
function Home1(){
    return(
        ...
        <div className="flex w-screen h-screen justify-center align-middle gap-28 py-32 bg-gray-100">
            <div className='w-2/6  mt-10'>
                <Image src={fb} alt="Fb" width="340" height="140"/>
            ...
            <div className='flex flex-col'>
                <div className='shadow-xl bg-white rounded-lg py-6'>
                     <div className="text-center">
                           <input type="text" placeholder="Email address or phone number" className='w-5/6 text-lg outline:none  border-slate-400  border-2 rounded-md  outline-slate-400 hover:focus:outline-blue-500 mt-4 mb-5 w-80 py-2 px-4'/><br></br>
                              <input type="text" placeholder="Password" className='text-lg mb-5 w-5/6 border-slate-400  border-2 rounded-md  outline:none outline-slate-400 hover:border-blue-700 mt-4 py-2 px-4'/><br></br>
